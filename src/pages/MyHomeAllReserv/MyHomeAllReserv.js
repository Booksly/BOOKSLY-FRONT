        ...
        <div className="myHomeAllReserv">
            <div className="container-2">
                ...
                취소내역삭제
                    ...
                    <span className="container-85">
                      레이슨 네일샵
                    </span>
                                        <div className="container-86">
                                            |
                                        </div>
                                        <span className="container-87">
                      서울시 마포구 창전동
                    </span>
                ...
                예약취소
                  ...
                  <span className="container-48">
                    [가게주인이 적은 타이틀] [메뉴] - [[소분류]] [설명]
                  </span>
                                </div>
                                <div className="frame-2911">
                                    <div className="line-113">
                                    </div>
                                    <div className="frame-455">
                                        <div className="frame-101">
                      <span className="review-1">
                        Review
                      </span>
                                        </div>
                  ...
                  <span className="container-65">
                    [가게주인이 적은 타이틀] [메뉴] - [[소분류]] [설명]
                                ...
                                <div className="frame-2912">
                                    ...
                                    <div className="frame-4551">
                                        <div className="frame-1011">
                      <span className="review-2">
                        Review
                      </span>
                                        </div>
