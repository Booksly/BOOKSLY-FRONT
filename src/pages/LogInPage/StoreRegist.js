...
import home from "../../assets/booksly_logo.png";
import storeimg from "../../assets/AddStoreImg_button.png";
            ...
            <div className="header-inner-left">
              ...
              <div className="header-buttons">
                <div className="nav-box">
                  <span className="container-66">가게조회</span>
                </div>
              </div>
            </div>
            <div className="header-inner-right">
              <div className="icon-home">
                <img className="vector-7" src={home} alt={""} />
              </div>
              <div className="go-mypage">
                <span className="container-65">북슬리 홈</span>
              </div>
            </div>
          </div>
              ...
              <div className="frame-533">
                ...
                <div className="frame-5331">
                  <div className="frame-5171">
                    <span className="container-12">201호</span>
                  </div>
                </div>
              </div>
            ...
            <div className="frame-574">
              ...
              <div className="frame-573">
                ...
                <div className="frame-568">
                  <img className="vector-2" src={storeimg} alt={""} />
                </div>
              </div>
            </div>
          </div>
